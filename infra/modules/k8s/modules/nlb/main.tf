...
resource "aws_lb" "aws-nlb-api" {
  ...
  subnets                          = length(var.aws_subnet_ids_private) <= length(var.aws_avail_zones) ? var.aws_subnet_ids_private : slice(var.aws_subnet_ids_private, 0, length(var.aws_avail_zones))
