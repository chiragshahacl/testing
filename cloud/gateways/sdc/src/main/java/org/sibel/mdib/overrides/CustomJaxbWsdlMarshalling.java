 ...
 */
public class CustomJaxbWsdlMarshalling extends AbstractIdleService implements WsdlMarshalling {
    private static final Logger LOG = LogManager.getLogger(org.somda.sdc.dpws.wsdl.JaxbWsdlMarshalling.class);
    ...
    @Inject
    public CustomJaxbWsdlMarshalling(
