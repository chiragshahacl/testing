...
const meta: Meta<typeof TechnicalLogin> = {
  component: TechnicalLogin,
  title: 'Technical/ITLogin',
  decorators: [
    withI18next,
    (Story) => {
      onReplace.mockReset();
  ...
  parameters: {
    ...
    msw: {
      handlers: [
        rest.post('/web/auth/technical/token', (req, res, ctx) => {
          return res(
            ctx.json({
              access: 'access',
              token: 'token',
...
export default meta;
type Story = StoryObj<typeof TechnicalLogin>;
...
export const SuccessfulLogin: Story = {
  play: async ({ canvasElement }) => {
    ...
    await waitFor(() => {
      ...
      expect(onReplace).toHaveBeenCalledWith('/technical/home');
    });
  },
};
