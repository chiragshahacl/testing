...
const meta: Meta<typeof RespiratoryPulseRate> = {
  component: RespiratoryPulseRate,
  title: 'Metrics/RespiratoryPulseRate',
  args: {
    isConnected: true,
    isError: false,
    isLoading: false,
...
export default meta;
type Story = StoryObj<typeof RespiratoryPulseRate>;
